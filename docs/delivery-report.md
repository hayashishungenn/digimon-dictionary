...
|---|---|
| **总收录 Digimon** | **1,736** |
| 官方图鉴（is_official_reference） | **1,316 / 1,316（100%）** |
| 扩展图鉴 | 420 |
| 拥有中文名 | 1,495（86.1%，其中 83 条为标 unverified 的音译） |
| 拥有英文名 | 1,736（100%） |
| 拥有日文名 | 1,654 |
| 三语言完整率 | 1,494 / 1,736（86.1%） |
...
- 约 241 只扩展/冷门数码兽缺简体中文名（已系统探查 digimons.net / Wikimon ol / 官方ZH-CN / Baidu / Fandom / 灰机wiki / 萌娘百科，均无可靠来源；不编造）
- 83 条音译名明确标 `transliteration` + unverified（UI 显示"音译·未验证"），非官方定名
