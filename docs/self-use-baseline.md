...
本文件保留 S0-0 的历史基线（当时 schema v7、realdb 18/18）；后续任务的当前数据与验收结果见 `docs/next-stage-status-2026-08-19.md`。当前真实库已为 schema v8、snapshot 2026-08-16、1,736 条，realdb E2E 为 24/24，fixture E2E 为 26/26，manifest/report/DB 哈希一致。
